...
ARTEMIS_INSTANCE='/var/lib/slave-broker'
ARTEMIS_DATA_DIR='/var/lib/slave-broker/data'
ARTEMIS_ETC_DIR='/var/lib/slave-broker/etc'
ARTEMIS_OOME_DUMP='/var/lib/slave-broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/var/lib/slave-broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/var/lib/slave-broker/etc/'
